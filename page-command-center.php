 ...
 * then JM Training (departments: Marketing, Community Engagement), then the
 * four sites wired from it (Bourbonnais, Alsip, Frankfort, ECommerce). Each
 * block collapses its departments, and each department collapses its KPIs.
 * A block's color comes from the share of KPIs met inside it; JM Training
 * also counts the sites below it. Every KPI is scored green / orange /
 ...
 *     includeChildren  true folds the KPIs of every block wired from this one
 *                      into its color and counts (JM Training counts the
 *                      locations below it as well as its own departments).
		...
		[
			...
			'departments' => [
				[
					...
					'kpis' => [
					[
						'id' => 'weekly-sales-email',
						'label' => 'Weekly Sales Email',
						'type' => 'check',
						'unit' => '',
						'green' => 1,
						'orange' => 1,
				...
				[
					...
					[
						...
						'orange' => 1,
						'value' => true,
						'target' => 'General knowledge / updates post in the community',
					],
					[
						'id' => 'community-email',
						...
						'orange' => 1,
						'value' => false,
						'target' => 'General knowledge / updates email sent',
					],
					[
						'id' => 'new-members',
						'label' => 'New Members',
					...
					[
						...
						'orange' => 4,
						'value' => 1,
						'target' => 'Under 2 cancellations a day',
					],
					],
				],
			],
